...
for radius in radii:
    ...
    print(
        f"Resonance frequency = {f_res:.5f}"
    )
...
# Fine radius vs minimum transmission
...
plt.annotate(
    f"Best radius = {best_radius:.2f}\n"
    f"Minimum T = {best_transmission:.4f}",
    xy=(
        best_radius,
        best_transmission
    ),
...
# Fine radius vs resonance frequency
...
# Full fine-radius transmission spectra
...
plt.title(
    "Fine Radius Transmission Spectra"
)
...
print()
print("FINE RADIUS SWEEP COMPLETE")
print()
print("Saved:")
print("fine_radius_sweep.png")
print("fine_radius_resonance.png")
print("fine_radius_transmission_sweep.png")
